              ...
              <div className="text-center  mb-[50px]">
                ...
                <div className="mx-[20px] md:mx-[120px] xl:mx-[220px] ">
                  <span className="text-[17px] font-semibold">
                    ...
                    capturing the genius of engineers, their ground-breaking
                    discoveries, and their significant influence on society.
                    <br />
                    The colors and other sketches are to be brought by
                    participants according to their ideas.
                  </span>
                </div>
              </div>
              <div className="text-center  mb-[50px]">
          ...
          >
            <div className="flex justify-center mt-[10px] text-[17px] text-center">
              <div>
                <div>
                  <span>
                    This is a <b>single round</b> event.
                  </span>
                </div>
                <div className="mx-[10px]">
                  <span>
                    Participants will be have <b>2 hours</b> to design their
                    poster and submit it for judgement.
                  </span>
                </div>
              </div>
            </div>
              ...
              <div>
                <div>
                  <span className="font-bold">
                    Slogans, Attractiveness and Theme specific{" "}
                  </span>
                </div>
                <div className="mt-[10px] mx-[10px]">
                  <span>
                    Your poster will we judged based on the Slogans, designs,
                    and how much it is related to the theme.
                  </span>
                </div>
              </div>
            </div>
