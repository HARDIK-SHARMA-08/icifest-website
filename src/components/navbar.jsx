...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <header className={`mx-[20px] flex justify-center pt-[10px] pr-[15px] pl-[15px] min-[375px]:pr-[25px] min-[375px]:pl-[25px] pb-[10px] sticky top-0 z-10 duration-200 ${divClass} z-50 `}>
